            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/visitoroffer') }}">
                            @csrf
                            ...
                            <input type="hidden" name="transaction_type" value="Visitor_Offer"/>
                            ...
                            <div class="form-group row">
                                <label for="offer_price" class="col-md-4 col-form-label text-md-right">{{ __('offer_price') }}</label>

                                <div class="col-md-6">
                                    <input id="offer_price" type="text" class="form-control" name="offer_price" required>
                                </div>
