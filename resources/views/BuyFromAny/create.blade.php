        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-header">{{ __('Buy From Any Transaction') }}
                        @if(isset($message))<a class="btn  btn-info valid-feedback">success</a>@endif</div>

                    <div class="card-body">

                        <form method="POST" action="{{ url('/buyfromany') }}">
                            @csrf
                            ...
                            <input type="hidden" name="transaction_type" value="buy_from_any"/>
                            ...
                            <div class="form-group row">
                                <label for="buyer_price" class="col-md-4 col-form-label text-md-right">{{ __('buyer_price') }}</label>

                                <div class="col-md-6">
                                    <input id="buyer_price" type="text" class="form-control" name="buyer_price" required>
                                </div>

                                @if ($errors->has('buyer_price'))
                                    <span class="invalid-feedback">
                                        <strong>{{ $errors->first('buyer_price') }}</strong>
                                    </span>
                                @endif
                            </div>
